...
object Key {
  ...
  val scan_code="scan_qr_code"
  val select_experience="select_experience"
  val parent_experience="parent_experience"
  val remain_flow="remain_flow"
  val remain_day="remain_day"
}
