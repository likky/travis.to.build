...
import android.content.{Intent, SharedPreferences, _}
import android.net.Uri
import android.os.{Bundle, Looper}
...
object ShadowsocksInfoSettings {
  // Constants
  private final val TAG = "ShadowsocksInfoSettings"
...
class ShadowsocksInfoSettings extends PreferenceFragment with OnSharedPreferenceChangeListener {
  import ShadowsocksInfoSettings._

  private def activity = getActivity.asInstanceOf[ShadowsocksInfoActivity]
  ...
  override def onCreate(savedInstanceState: Bundle) {
    ...
    addPreferencesFromResource(R.xml.pref_all_info)
