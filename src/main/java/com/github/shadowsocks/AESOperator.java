...
public class AESOperator {
     ...
     */
    private String sKey = "fkKQ1j7M9LPvs2tXhrxgHZOiJn5dY60S";//key，可自行修改
    private String ivParameter = "EnIbrQkgcKARd36S";//偏移量,可自行修改
...
//    }
    ...
    public String encrypt(String sSrc) throws Exception {
        ...
        return new String(Base64.encode(encrypted,encrypted.length));// 此处使用BASE64做转码。
    }
