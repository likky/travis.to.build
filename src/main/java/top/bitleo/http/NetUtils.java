...
/**
 * Created by bitleo on 2018/9/12.
 */
...
//    public static final String APP_UPDATE_OTHER ="https://fly.517.bz/experience/mobileUserAppUp/";
    ...
    private NetUtils() {
        ...
        ClientBuilder.writeTimeout(5, TimeUnit.SECONDS);//写入超时
        //支持HTTPS请求，跳过证书验证
     ...
     * @param myNetCall
     */
    public  void postDataAsynToNet(String url, String value,final MyNetCall myNetCall) {
        //1构造RequestBody
        RequestBody body=setRequestBody(value);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
        Request request = requestBuilder.post(body).url(url).build();
        //3 将Request封装为Call
     ...
     * @return
     */
    private RequestBody setRequestBody(String value){
